...
function blobToDataUrl(blob: Blob): Promise<string> {
  return new Promise((resolve, reject) => {
    ...
    r.onerror = () => reject(new Error(i18n.t("voiceDictation.errors.readError")));
    ...
    try {
      ...
      rec.onstop = async () => {
        ...
        try {
          ...
          else toast.info(t("voiceDictation.toast.noSpeech"));
        } catch (e) {
          toast.error(t("voiceDictation.toast.error"), { description: (e as Error).message });
        } finally {
          setBusy(false);
        }
      };
      ...
      toast.error(t("voiceDictation.toast.micUnavailable.title"), {
        description: t("voiceDictation.toast.micUnavailable.text"),
      });
    }
  }
    ...
    <div className={className}>
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {busy
            ? t("voiceDictation.transcribing")
            : recording
              ? t("voiceDictation.stop")
              : t("voiceDictation.dictate")}
        </Button>
        <Select
          value={lang}
          onValueChange={(v) => {
