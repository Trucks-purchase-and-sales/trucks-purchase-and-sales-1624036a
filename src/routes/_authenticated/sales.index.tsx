    ...
    <div className="space-y-6 pb-10">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <QuickAction
          to="/admin/leads"
          icon={Inbox}
          title={t("sales.quickActions.leadsInbox.title")}
          description={t("sales.quickActions.leadsInbox.description")}
        />
        <QuickAction
          to="/admin"
          icon={Briefcase}
          title={t("sales.quickActions.pipeline.title")}
          description={t("sales.quickActions.pipeline.description")}
        />
        <QuickAction
          to="/admin/matching"
          icon={Sparkles}
          title={t("sales.quickActions.matching.title")}
          description={t("sales.quickActions.matching.description")}
        />
      </div>
    </div>
  );
