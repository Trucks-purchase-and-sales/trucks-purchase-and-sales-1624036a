...
function DirectionHome() {
  ...
  return (
    <div className="space-y-6 pb-10">
      <div>
        <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">{t("direction.title")}</h1>
        <p className="mt-1 text-sm text-muted-foreground">{t("direction.subtitle")}</p>
      </div>
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
          <StatTileLink
            loading={isLoading}
            label={t("direction.kpi.total")}
            value={data?.total ?? 0}
            icon={TrendingUp}
          ...
          <StatTileLink
            loading={isLoading}
            label={t("direction.kpi.activePartners")}
            value={data?.partenaires ?? 0}
            icon={Users}
          ...
          <StatTileLink
            loading={isLoading}
            label={t("direction.kpi.dealsWon")}
