    ...
    Tables: {
      ...
      demand_opportunity_status_history: {
        Row: {
          ...
          old_status:
            | Database["public"]["Enums"]["demand_opportunity_status"]
            | null
        }
        Insert: {
          changed_by?: string | null
      ...
      vehicle_opportunities: {
        Row: {
          ...
          general_condition:
            | Database["public"]["Enums"]["general_condition"]
            | null
          ...
          price_negotiable:
            | Database["public"]["Enums"]["negotiable_state"]
            | null
          ...
          quality_score:
            | Database["public"]["Enums"]["opportunity_quality"]
            | null
          reference_number: string | null
          referral_code: string | null
          referred_by: string | null
          ...
          technical_inspection_status:
            | Database["public"]["Enums"]["tri_state"]
            | null
          ...
          vin: string | null
          visible_on_site:
            | Database["public"]["Enums"]["visibility_state"]
            | null
